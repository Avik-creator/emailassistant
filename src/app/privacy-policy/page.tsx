  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-green-100">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-green-300">1. Introduction</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-green-300">2. Information We Collect</h2>
          <h3 className="text-xl font-medium mb-2 text-green-200">2.1 Account Information</h3>
          ...
          <h3 className="text-xl font-medium mb-2 text-green-200">2.2 Email Data</h3>
          <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-green-300">3. How We Use Your Information</h2>
          <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-green-300">4. Data Security</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-green-300">5. Data Sharing</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-green-300">6. AI Processing</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-green-300">7. Your Rights</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-green-300">9. Contact Us</h2>
          <p className="mb-4">
